...
public class CaptureAllContactsNames {

	@Test
	public void capturesAllContactNames() throws IOException {
		...
		List<WebElement> contacts = driver.findElements(By.xpath("//table[@class='lvt small']/tbody/tr[*]/td[4]"));
